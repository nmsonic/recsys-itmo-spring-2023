...
from botify.recommenders.contextual_with_toppop import ContextualAndTopPop
...
class NextTrack(Resource):
    def post(self, user: int):
        ...
        if treatment == Treatment.T1:
            recommender = ContextualAndTopPop(tracks_redis.connection, catalog, catalog.top_tracks[:100])
        else:
